...
dict1_for_get_links = {'landing': ['/Users/reynimanuelcalderoncots/Desktop/entregable_tfm/tests/resources/csv/listings.csv',  # CHANGE FOR YOR OWN PATH => ....YOUR PATH/tests/resources/csv/listings.csv
                                   '/Users/reynimanuelcalderoncots/Desktop/entregable_tfm/tests/resources/csv/crimes.csv',  # CHANGE FOR YOR OWN PATH => ....YOUR PATH/tests/resources/csv/crimes.csv
                                   '/Users/reynimanuelcalderoncots/Desktop/entregable_tfm/tests/resources/csv/comments.csv']}  # CHANGE FOR YOR OWN PATH => ....YOUR PATH/tests/resources/csv/comments.csv
...
@pytest.mark.parametrize( # CHANGE FOR YOR OWN PATH => ....YOUR PATH/tests/resources/csv/listings.csv (ONLY FIRST EXPECTED PARAMETER)
'expected', [('/Users/reynimanuelcalderoncots/Desktop/entregable_tfm/tests/resources/csv/listings.csv', 'id,name,host_id,host_name,'
